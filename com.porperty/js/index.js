var $, tab, skyconsWeather, loginCtrl;
layui.config({
    base: "js/"
}).use(['bodyTab', 'form', 'element', 'layer', 'jquery', 'login', 'network'], function () {
    var form = layui.form,
        layer = layui.layer,
        network = layui.network(layui.jquery),
        element = layui.element;
    $ = layui.jquery;
    loginCtrl = layui.login;

    tab = layui.bodyTab({
        openTabNum: "50",  //最大可打开窗口数量
        url: "json/navs.json?date=" + (+new Date()), //获取菜单json地址
        isLocal: true
    });
